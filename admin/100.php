...
$path ="../docu/$file_name";
    ...
    alert('please enter valid information');</script>";
        ...
        $query = "INSERT INTO past_1( email,title,file) VALUES( '$email','$title','$file_name')";
...
<div class="container w-50 bg-dark">
    ...
    <form method="post" enctype = "multipart/form-data" class="form-group">
                   ...
                   <label for="" >email</label>
                    ...
                    <input type="file" name="pdf" placeholder="enter the file"  id="fileToUpload"  required class="form-control">
                    <button type="submit" name="submit" class="btn btn-primary txt-light mt-2" value="Upload video">Submit</button>
